...
registerBlockType("ssbcodeblocks/header", {
  title: "Header - SSBCode",
  attributes: {
    text: {type: "string"},
...
function EditComponent(props) {
  ...
  return (
    <>
      ...
      <RichText tagName="h2" className={`headline headline--${props.attributes.size}`} value={props.attributes.text} onChange={handleTextChange} />
    </>
  );
}
