...
class Search {
  ...
  constructor() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#searchInput").blur(function () {
      setTimeout(() => {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#result-list").hide();
      }, 200);
    }); //find and display the new articles

    var runSearch = function (search) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(ssbcodeData.root_url + "/wp-json/wp/v2/works?search=" + search, res => {
